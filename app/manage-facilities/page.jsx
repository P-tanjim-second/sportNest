...
import EditFacilityModal from '../../components/EditFacilityForm';
        ...
        {isEditOpen && (
          <motion.div
            ...
            style={{
              ...
              background: 'rgba(22,51,42,0.55)', backdropFilter: 'blur(6px)',
              WebkitBackdropFilter: 'blur(6px)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              padding: 20,
            }}
          ><motion.div
            initial={{ y: -20, scale: 0.9, scaleY: 1 }}
            animate={{ y: 0, scale: 1, scaleY: 1 }}
            exit={{ y: -20, scale: 0.9, scaleY: 0.5 }}
            transition={{
              type: 'spring',
              stiffness: 400,
              damping: 30,
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-10">
        ...
        {loading ? (
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex flex-1 flex-col sm:flex-row sm:items-center gap-4 p-5">
                    ...
                    <div className="flex items-center gap-2">
                      <button onClick={() => { setIsEditOpen(true); setSelectedFacility(f); }} className="inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-semibold transition-all duration-300 hover:-translate-y-0.5"
                        style={{ background: 'var(--color-pine)', color: 'var(--color-paper)', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div className="py-24 text-center">
            ...
            <Link href="/add-facility" className="inline-flex items-center gap-2 rounded-full px-6 py-2.5 text-sm font-semibold"
